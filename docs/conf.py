# -*- coding: utf-8 -*-
#
# BERT2Punc documentation build configuration file, created by
# sphinx-quickstart.
#
...
htmlhelp_basename = "bert2puncdoc"
...
latex_documents = [
    ("index", "bert2punc.tex", u"BERT2Punc Documentation", u"BJD, JHT, MES", "manual"),
]
...
man_pages = [("index", "bert2punc", u"BERT2Punc Documentation", [u"BJD, JHT, MES"], 1)]
